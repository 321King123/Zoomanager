...
public class EnclosureTaskRepositoryTest {
    ...
    public void eventSearch_allSearchParametersNullReturnAll() {
        ...
        EnclosureTask ec3 = EnclosureTask.builder()
            ...
            .build();
        enclosureTaskRepository.save(ec3);
        List<EnclosureTask> enclosureTasks = enclosureTaskRepository.findFilteredEvents(Task.builder().build());
        assertEquals(enclosureTasks.size(), 3);
    ...
    public void eventSearch_noEvents() {
        ...
        enclosureTaskRepository.save(ec3);
        List<EnclosureTask> enclosureTasks = enclosureTaskRepository.findFilteredEvents(Task.builder().build());
        assertEquals(enclosureTasks.size(), 0);
    ...
    public void eventSearch_searchDescriptionAndTitle() {
        ...
        List<EnclosureTask> enclosureTasks = enclosureTaskRepository.findFilteredEvents(searchTask);
        assertEquals(enclosureTasks.size(), 1);
